...
- API Secret: ב-.env.local (לא ב-Git)
- Package: next-cloudinary מותקן ב-apps/web
- ENV vars ב-apps/web/.env.local:
...
## Sprint נוכחי - Sprint 7

**מה הושלם ב-Sprint 6+7:**
- ✅ BusinessKnowledgeBase - מאגר ידע ל-50+ סוגי עסקים
- ✅ OnboardingPlan נשמר ב-Business Profile ב-MongoDB
- ✅ כל שדות ה-AI Insights נשמרים (צבעים, טון, קהל יעד, KeyFeatures)
- ✅ PhotosUploadScreen - העלאת תמונות עם Drag & Drop לפי קטגוריות
- ✅ תצוגה מקדימה של תמונות
- ✅ Cloudinary מוגדר (Cloud: dmi0exthg)
- ✅ next-cloudinary מותקן

**Flow אונבורדינג מלא:**
1. שם עסק
2. סוג עסק
3. שאלת העמקה AI
4. קטגוריות (אם רלוונטי)
3.5. העלאת תמונות לפי קטגוריות
4. Welcome screen

**הצעד הבא - Sprint 8:**
- העלאת תמונות לCloudinary בפועל (כרגע רק local preview)
- שמירת URLs של התמונות ב-Business Profile ב-MongoDB
- Website Agent - בניית אתר ראשון לפי כל המידע שנאסף
